...
/**
 * Classe representant le MOJO d'execution de commandes sur le serveur Wildfly 
 * @author <a href="mailto:jetune@leadware.net">Jean-Jacques ETUNE NGI (Enterprise Architect)</a>
 * @since 2014-07-27 15:22:01
 */
@Mojo(name="execute-commands", threadSafe=true)
public class ExecuteCommandsMojo extends org.wildfly.plugin.cli.ExecuteCommandsMojo {}
